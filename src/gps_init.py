...
class GPS_init:
	...
	def __init__(self):
		...
		self.gps_origin_sub = rospy.Subscriber('/target/mavros/global_position/global', NavSatFix, self.gps_origin_cb)
		...
		self.pose_pub = rospy.Publisher('mavros/local_position/pose_initialized', PoseStamped, queue_size=10)
	...
	def gps_origin_cb(self, msg):
		self.latO = msg.latitude
		self.lonO = msg.longitude
		self.altO = msg.altitude
